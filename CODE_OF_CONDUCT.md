...
maintainers. Use the repository's private reporting mechanism and identify the
report as a Code of Conduct matter. If no private mechanism is available, open
a minimal issue asking for private maintainer contact without including names,
screenshots, or incident details.

All reports will be reviewed and investigated as promptly and fairly as
practicable. Maintainers must respect the privacy and security of reporters.

## Enforcement guidelines

Maintainers will use these guidelines when determining consequences:
...
**Consequence:** A private, written warning that explains the violation and
